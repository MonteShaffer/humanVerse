...
# [upc] ... do just data ... widths for 2-D ... and 3-D 
# separately create renderers ... 
# image magic can parse ... CHE-LOCO, how to read a random QR generated on the USER phone to the website ... display name is WHATEVER, if they STORE/SAVE it, they are repeat user ... hash IP/QR to prevent collision, then don't store/track anything about USER accept this... maybe keep in URL like oldschool PHP days ... the HASH ... if they bookmark, they are that HASH ... maybe not ?HASH but # |append to ANCHOR ... jquery removes from "anchor" object ... 
# [pdf] ... build from ros-pdf ... easy render ... I wish it could be developed for modern syntax like "Comments" ... replace Adobe Acrobat PROTECT
# ORACLE trademark issues? 
# [pdflatex] ... 
