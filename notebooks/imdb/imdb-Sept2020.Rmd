...
```{r}
IMDB.searchPersonName("Will*Smith")
```
...
will$bio= IMDB.getPersonInfo(will$nmid)
```
...
```{r}
will$movies = standardizeDollarsInDataFrame(will$movies, 2010, "millions", "year" , "millions2010")
```
